...
export class GettingStartedState {
  ...
  update = (step: Step): void => {
    ...
    this.progress = {
      ...
      'STEP2_ENTER_FIELD_NAME_DESCRIPTION': () => ({ index: 2, total: 2, done: 1 }),
      'STEP2_SELECT_TYPE_DESCRIPTION': () => ({ index: 2, total: 2, done: 1 }),
      'STEP2_CLICK_CONFIRM_DESCRIPTION': () => ({ index: 2, total: 2, done: 1 }),

      'STEP3_OPEN_PLAYGROUND': () => ({index: 3, total: 4, done: 0}),
      'STEP3_UNCOMMENT_DESCRIPTION': () => ({index: 3, total: 4, done: 0}),
      'STEP3_RUN_QUERY1': () => ({index: 3, total: 4, done: 0}),
      'STEP3_CREATE_MUTATION_TAB': () => ({index: 3, total: 4, done: 1}),
      'STEP3_ENTER_MUTATION1_VALUES': () => ({index: 3, total: 4, done: 1}),
      'STEP3_RUN_MUTATION1': () => ({index: 3, total: 4, done: 2}),
