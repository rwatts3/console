      ...
      <div className="container">
        ...
        <div className="flex itemsCenter pr38 edit-name">
          ...
          >
            <input
              className={
                'enter-event fieldNameInputField' +
                (errors.invalidName && showErrors ? ' error' : '')
              }
              autoFocus={true}
          ...
          <div className="flex itemsCenter">
            {errors.invalidName &&
              showErrors &&
              <ErrorInfo>
                The fieldname must start with a lowercase letter and should only
          ...
          : ((!description || description.length === 0) &&
            ...
            (description &&
              ...
              <div
                ...
                onMouseEnter={() =>
                  this.setState({ isHoveringDescription: true } as State)}
                onMouseLeave={() =>
                  this.setState({ isHoveringDescription: false } as State)}
                onClick={() =>
                  this.setState(
                    {
                      isEnteringDescription: true,
