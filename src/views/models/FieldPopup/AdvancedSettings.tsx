        ...
        <style jsx>
          {`
            ...
            .migration-title-wrapper {
              @p: .bb, .bBlack10, .flex, .justifyCenter, .mb38, .w100, .mt16,
                .pt4;
            }
          ...
          <div>
            <div className={`migration-title-wrapper ${mandatoryClass}`}>
              <div className={`migration-title ${mandatoryClass}`}>
                ...
                <Info width={300}>
                  For scalar fields, the migration value is applied to all{' '}
                  <pre>null</pre> values. For list fields, the migration value
            ...
            {showErrors &&
              ...
              <div className="migration-error">
                <ErrorInfo>
                  As you changed your field, you need to specify a migration
                  value.
                </ErrorInfo>
              </div>}
          </div>}
