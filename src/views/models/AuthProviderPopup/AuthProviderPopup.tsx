...
class AuthProviderPopup extends React.Component<Props, null> {
  componentWillMount() {
    if (
      ...
      this.props.params.provider.length === 0
    ) {
  ...
  componentDidMount() {
    tracker.track(
      ConsoleEvents.AuthProvider.Popup.opened({ source: 'user-model' }),
    )
  }

  render() {
    const authProviders = this.props.project.authProviders.edges.map(
      edge => edge.node,
    )
      ...
      <PopupWrapper onClickOutside={this.close}>
        ...
        >
          ...
          >
            ...
            >
              <div className={cx($p.f38, $p.fw3)}>Auth Providers</div>
            ...
            <div className={cx($p.flex, $p.justifyBetween)}>
              <div
                className={cx($p.flex, $p.flexColumn, $p.br, $p.bBlack10)}
              ...
              >
                <div
                  ...
                  onClick={() => {
                    ...
                    tracker.track(
                      ConsoleEvents.AuthProvider.Popup.providerSelected(),
                    )
                  }}
                >
                  <div className={cx($p.flex, $p.itemsCenter)}>
                    <Icon
                      ...
                      color="#00B861"
                    />
                    <div className={cx($p.fw3, $p.f25, $p.ml16)}>Email</div>
                  </div>
                  <div>
                    {authProviders.find(
                      a => a.type === 'AUTH_PROVIDER_EMAIL' && a.isEnabled,
                    ) &&
                      <Icon
                ...
                <div
                  ...
                  onClick={() => {
                    this.props.router.push(
                      `/${projectName}/integrations/authentication/anonymous`,
                    )
                  }}
                >
                  <div className={cx($p.flex, $p.itemsCenter)}>
                    <Icon
                      ...
                      color="#00B861"
                    />
                    <div className={cx($p.fw3, $p.f25, $p.ml16)}>Anonymous</div>
                  </div>
                  <div>
                    {false &&
                      <Icon
                ...
                <div
                  ...
                  onClick={() => {
                    this.props.router.push(
                      `/${projectName}/integrations/authentication/digits`,
                    )
                    tracker.track(
                      ConsoleEvents.AuthProvider.Popup.providerSelected(),
                    )
                ...
                >
                  ...
                  <div>
                    {authProviders.find(
                      a => a.type === 'AUTH_PROVIDER_DIGITS' && a.isEnabled,
                    ) &&
                      <Icon
                        src={require('assets/new_icons/check.svg')}
                        color="#7ED321"
                ...
                <div
                  ...
                  onClick={() => {
                    this.props.router.push(
                      `/${projectName}/integrations/authentication/auth0`,
                    )
                    tracker.track(
                      ConsoleEvents.AuthProvider.Popup.providerSelected(),
                    )
                ...
                >
                  ...
                  <div>
                    {authProviders.find(
                      a => a.type === 'AUTH_PROVIDER_AUTH0' && a.isEnabled,
                    ) &&
                      <Icon
                        src={require('assets/new_icons/check.svg')}
                        color="#7ED321"
