      ...
      <div className="example-project-right">
        <style jsx={true}>{`
          .example-project-right {
            @p: .flex, .flexColumn, .justifyCenter, .pl38, .pr60, .pv60,
              .flexFixed;
        ...
        <div className="subtitle">
          ...
          <span className="project-file">project.graphcool</span> in your
          current folder. Open it in your editor to update your schema. Learn
          more in the&nbsp;
          <A target="https://www.graph.cool/docs/reference/cli/project-files-ow2yei7mew/">
            docs
          </A>
        </div>
        ...
        <div className="info">
          You can apply your local changes via{' '}
          <span className="code">`graphcool push`</span>.
        </div>
      </div>
    )
  }
