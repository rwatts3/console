  ...
  render() {
    ...
    return (
      <div className="flex flex-column" style={{ maxWidth: 300 }}>
        ...
        <div
          style={{ flex: '1 0 auto' }}
          className="bg-black-05 w-100 flex flex-column justify-between"
        >
          ...
          <div>
            <div className="f-16 black-50 mh-25 mb-25 lh-1-4">
              Got stuck? Please contact us, we are always trying to improve and
              love to help!
            </div>
            <img
              className="db"
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(
    { nextStep, previousStep, skip, showCurrentStep },
    dispatch,
  )
}
