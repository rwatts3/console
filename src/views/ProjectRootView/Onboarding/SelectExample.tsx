...
class SelectExample extends React.Component<Props, State> {
  ...
  getDownloadUrl(example: Example) {
    /* tslint:disable-line */
    return `${__EXAMPLE_ADDR__}/?repository=${example.path}&project_id=${this
      .props.projectId}&user=graphcool-examples&subfolder=${example.subfolder}`
  }
  render() {
    ...
    return (
      <div className="select-example">
        ...
        <div className="intro">
          ...
          <p>
            You've successfully set up your GraphQL backend. It's now time to
            test it. <br />
        ...
        <div className="last">
          ...
          <div className="bottom">
            <div className="waiting">
              <WaitingIndicator />
              <span>
                Waiting for you to initialize the app. Once you're done, come
                back here...
              </span>
            </div>
