...
export default class MutationsInfoBox extends React.Component<Props, {}> {
      ...
      <div className="container">
        ...
        <div className="flex pl16 pv16">
          ...
          <div className="titleText">
            Based on the relation name, the following mutations can be used to
            mutate the relation:
          </div>
        </div>
        {this.props.leftSelectedModel &&
          this.props.rightSelectedModel &&
          this.generateMutationInfo(true)}
        {this.props.leftSelectedModel &&
          this.props.rightSelectedModel &&
          this.generateMutationInfo(false)}
      </div>
    )
  }
  ...
  private generateMutationInfo = (set: boolean): JSX.Element => {
    ...
    const payloadName =
      uppercaseFirstLetter(relationPrefix) + relationName + 'Payload'
    const mutationName = (
      <span className="blue">
