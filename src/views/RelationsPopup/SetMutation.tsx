...
export default class SetMutation extends React.Component<Props, State> {
      ...
      <div className="container">
        ...
        {isEnteringRelationName || relationName.length === 0
          ...
          : <div
              ...
              onMouseEnter={() =>
                this.setState({ isHoveringRelationName: true } as State)}
              onMouseLeave={() =>
                this.setState({ isHoveringRelationName: false } as State)}
              onClick={() =>
                this.setState(
                  {
                    isEnteringRelationName: true,
            ...
            >
              <div className="ph25 f38 fw3 black80">
                {relationName}
              </div>
              {this.state.isHoveringRelationName &&
                <Icon
                  className="ml6"
          ...
          : ((relationDescription === null ||
            ...
            (relationDescription.length > 0 &&
              <div
                ...
                onMouseEnter={() =>
                  this.setState(
                    { isHoveringRelationDescription: true } as State,
                  )}
                onMouseLeave={() =>
                  this.setState(
                    { isHoveringRelationDescription: false } as State,
                  )}
                onClick={() =>
                  this.setState(
                    {
              ...
              >
                <div className="f16 black50 mv25 pl25 pr6">
                  {relationDescription}
                </div>
                {this.state.isHoveringRelationDescription &&
                  <Icon
                    className="ml6"
                    src={require('../../assets/icons/edit_project_name.svg')}
                    width={20}
  ...
  private handleKeyDownOnRelationDescription = e => {
    if (e.keyCode === ENTER_KEY) {
      ...
      this.props.onChangeRelationDescriptionInput(
        this.state.savedRelationDescription,
      )
    }
  }
