    ...
    return (
      ...
      >
        ...
        >
          <Icon
            src={
              this.props.selectedCartinality === 'ONE_TO_ONE'
                ? oneToOneGreen
                : oneToOne
            }
            width={31}
        ...
        >
          <Icon
            className="pv6"
            src={
              this.props.selectedCartinality === 'ONE_TO_MANY'
                ? oneToManyGreen
                : oneToMany
            }
            width={31}
        ...
        >
          <Icon
            className="pv6"
            src={
              this.props.selectedCartinality === 'MANY_TO_ONE'
                ? oneToManyGreen
                : oneToMany
            }
            width={31}
        ...
        >
          <Icon
            className="pv6"
            src={
              this.props.selectedCartinality === 'MANY_TO_MANY'
                ? manyToManyGreen
                : manyToMany
            }
            width={31}
