...
class Authentication extends React.Component<Props, {}> {
  render() {
    const command = `graphcool auth --token "${cookiestore.get(
        ...
        <div>
          <div className="headerContent">
            ...
            <div className="headerDescription">
              To authenticate with the graphcool cli without a browser, use the
              following command
              <Copy text={command}>
                <pre>
                  {command}
          ...
          <div className="headerContent">
            ...
            <div className="headerDescription">
              You can use Permanent Access Tokens to grant access to
              authenticated actions as an alternative way to creating an
              authenticated user.
            </div>
          </div>
