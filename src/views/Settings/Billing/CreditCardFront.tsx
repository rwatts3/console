...
export default class CreditCardFront extends React.Component<Props, State> {
      ...
      return (
        <div className="topEditing">
          ...
          <div className="buttons">
            <div onClick={() => this.props.setEditingState(false, false)}>
              <Icon
                className="pointer"
            ...
            <div onClick={() => this.props.setEditingState(false, true)}>
              <Icon
  ...
  private bottomPart = () => {
    return !this.props.isEditing
      ? <div className="bottomNonEditing" style={{ marginTop: '-20px' }}>
          <style jsx={true}>{`
            .creditCardNumber {
              @p: .f20, .white;
          ...
          <div className="flex justifyBetween mt16">
            <div>
              ...
              <div className="f16 white creditCardFont mt6">
      ...
      : <div className="bottomEditing" style={{ marginTop: '-20px' }}>
          <style jsx={true}>{`
            .bottomNonEditing {
              @p: .flex, .flexColumn, .ph10;
            }
            ...
            .inputField {
              @p: .br2, .ba, .bDashed, .bWhite30, .bgTransparent, .pt10, .pb6,
                .ph10;
            }
          ...
          <div className="flex justifyBetween mt10 mr16 mb10">
            <div>
              ...
              <input
                ...
                onChange={(e: any) =>
                  this.props.onCardHolderNameChange(e.target.value)}
            ...
            <div className="">
              ...
              <input
                ...
                placeholder="MM/YY"
                onChange={(e: any) =>
                  this.props.onExpirationDateChange(e.target.value)}
