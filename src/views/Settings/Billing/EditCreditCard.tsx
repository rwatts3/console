...
export default class EditCreditCard extends React.Component<Props, State> {
  ...
  private inputForCurrentDisplayState = () => {
      ...
      return (
        <div>
          ...
          <div className="relative">
            ...
            />
            <div
              className={`toggleDisplayStateButton ${!this.props
                .creditCardDetailsValid && 'o50'}`}
            >
              <div
                className="blue"
                onClick={() =>
    ...
    return <div>unknown display state</div>
  }
    ...
    return (
      <div className="">
        ...
        <input
          ...
          onChange={(e: any) =>
            this.props.onAddressDataChange('addressLine1', e.target.value)}
          type="text"
          onKeyDown={this.handleKeyDown}
          autoFocus={true}
        />
        ...
        <input
          ...
          onChange={(e: any) =>
            this.props.onAddressDataChange('addressLine2', e.target.value)}
          onKeyDown={this.handleKeyDown}
          type="text"
        />
        <div className="flex">
          <div>
            ...
            <input
              ...
              onChange={(e: any) =>
                this.props.onAddressDataChange('zipCode', e.target.value)}
              type="text"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e: any) =>
                this.props.onAddressDataChange('state', e.target.value)}
              onKeyDown={this.handleKeyDown}
              type="text"
            />
          </div>
        ...
        <div className="flex">
          <div>
            ...
            <input
              ...
              onChange={(e: any) =>
                this.props.onAddressDataChange('city', e.target.value)}
              onKeyDown={this.handleKeyDown}
              type="text"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e: any) =>
                this.props.onAddressDataChange('country', e.target.value)}
              onKeyDown={this.handleKeyDown}
              type="text"
            />
          </div>
