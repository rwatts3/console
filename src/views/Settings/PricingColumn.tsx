...
export default class PricingColumn extends React.Component<Props, {}> {
        ...
        <div className="pv25">
          <div className="flex">
            ...
            <div className="ml10">
              ...
              <div className="f12" style={{ color: this.primaryTextColor() }}>
                Nodes
              </div>
            </div>
          </div>
  ...
  private actionButton = (title?: string): JSX.Element => {
    ...
    const actionButtonTitle =
      title ||
      (this.props.isDisplayedInConfirmPlan ? 'Change Plan' : 'Choose Plan')
    return (
      <div
  ...
  private backgroundColor = (): string => {
    ...
    switch (this.props.plan) {
      case '2017-02-free':
        return 'rgba(241,143,1,.1)'
      case '2017-02-project':
        return 'rgba(28,191,50,.07)'
      case '2017-02-startup':
        return 'rgba(28,191,50,.07)'
      case '2017-02-growth':
        return 'rgba(28,191,50,.07)'
      case 'enterprise':
  ...
  private storage = () => {
    const storage =
      billingInfo[this.props.plan].maxStorage >= 1000
  ...
  private secondaryTextColor = (): string => {
    ...
    switch (this.props.plan) {
      case '2017-02-free':
        return 'rgba(241,143,1,.5)'
      case '2017-02-project':
        return 'rgba(28,191,50,.5)'
      case '2017-02-startup':
        return 'rgba(28,191,50,.5)'
      case '2017-02-growth':
        return 'rgba(28,191,50,.5)'
  ...
  private priceTag = (): JSX.Element => {
    if (this.props.plan === '2017-02-free') {
      return (
        <div className="f38 fw3" style={{ color: this.primaryTextColor() }}>
          Free
        </div>
      )
    } else {
      ...
      return (
        <div className="flex itemsEnd">
          ...
          <div className="f20" style={{ color: this.secondaryTextColor() }}>
            /mo
          </div>
        </div>
      )
  ...
  private requestsIcon = () => {
    ...
    switch (this.props.plan) {
      case '2017-02-free':
        return require('../../assets/icons/requests_orange.svg')
      case '2017-02-project':
        return require('../../assets/icons/requests_green.svg')
      case '2017-02-startup':
        return require('../../assets/icons/requests_green.svg')
      case '2017-02-growth':
        return require('../../assets/icons/requests_green.svg')
