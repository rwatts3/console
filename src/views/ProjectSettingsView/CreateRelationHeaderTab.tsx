...
interface Props {
  title: string
  selected: boolean
  onClick: (displayState: RelationPopupDisplayState) => void
}

export default class CreateRelationHeaderTab extends React.Component<
  Props,
  {}
> {
  render() {
    ...
    return (
      <div className="relative">
        ...
        <div
          className={`titleTab ${this.props.selected
            ? selectedTabColor
            : unselectedTabColor}`}
  ...
  private underlineSelection = (): JSX.Element => {
    ...
    const backgroundColor =
      selected && title === 'Set Mutations' ? 'white' : 'rgba(250,250,250,1)'
    return (
      <div
